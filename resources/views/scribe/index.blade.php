    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="expenses">
                    <a href="#expenses">Expenses</a>
                                ...
                                <a href="#expenses-GETapi-expenses">Get a list of all expenses

Optional filters:</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="expenses-POSTapi-expenses">
                                <a href="#expenses-POSTapi-expenses">Create a new expense</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="expenses-GETapi-expenses--id-">
                                <a href="#expenses-GETapi-expenses--id-">Get a specific expense by ID</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="expenses-PUTapi-expenses--id-">
                                <a href="#expenses-PUTapi-expenses--id-">Update an existing expense</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="expenses-DELETEapi-expenses--id-">
                                <a href="#expenses-DELETEapi-expenses--id-">Delete an expense</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>This API is not authenticated.</p>
        ...
        <h1 id="expenses">Expenses</h1>
                                ...
                                <h2 id="expenses-GETapi-expenses">Get a list of all expenses
...
<div class="bash-example">
    ...
    --get "http://localhost:8000/api/expenses?category=food%2Chealth&amp;date_from=2024-01-01&amp;date_to=2024-12-31" \
...
<i>optional</i> &nbsp;
    ...
    <br>
<p>Filter by category. Example: <code>food,health</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               data-component="query">
    <br>
<p>date Filter start date. Example: <code>2024-01-01</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               data-component="query">
    <br>
<p>date Filter end date. Example: <code>2024-12-31</code></p>
            </div>
                </form>

                    <h2 id="expenses-POSTapi-expenses">Create a new expense</h2>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>One of: food,health,transport,entertainment,utilities,others Example: <code>food</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>date</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Example: <code>2024-06-01</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>optional Example: <code>With colleagues</code></p>
        </div>
        </form>

                    <h2 id="expenses-GETapi-expenses--id-">Get a specific expense by ID</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/expenses/a18a8e55-7c20-4e93-a8d7-55b3b5b2a9d7" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/expenses/a18a8e55-7c20-4e93-a8d7-55b3b5b2a9d7"
);
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="a18a8e55-7c20-4e93-a8d7-55b3b5b2a9d7"
               data-component="url">
    <br>
<p>The UUID of the expense. Example: <code>a18a8e55-7c20-4e93-a8d7-55b3b5b2a9d7</code></p>
            </div>
                    </form>

                    <h2 id="expenses-PUTapi-expenses--id-">Update an existing expense</h2>
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>optional Example: <code>Burger</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>amount</code></b>&nbsp;&nbsp;
<small>number</small>&nbsp;
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>optional Example: <code>30</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>category</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>optional One of: food,transport,utilities Example: <code>food</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>expense_date</code></b>&nbsp;&nbsp;
<small>date</small>&nbsp;
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>optional Example: <code>2024-06-20</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>notes</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>optional Example: <code>Changed location</code></p>
        </div>
        </form>

                    <h2 id="expenses-DELETEapi-expenses--id-">Delete an expense</h2>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The UUID of the expense to delete. Example: <code>a18a8e55-7c20-4e93-a8d7-55b3b5b2a9d7</code></p>
            </div>
                    </form>
